...
<?php //echo '当前分页'.get_query_var('paged');?>
<div id="main">
	<div class="left">
		<div class="index_hot">
			<h1><b>Category</b> <a href=""<?php echo home_url('/')?>">首页</a>&nbsp;&nbsp;&raquo;&nbsp;&nbsp;<span style="color:#B90103;">分类
              <?php echo $cat_obj->name?> 下的作品（<?php echo $cat_obj->category_count?>篇）</span></h1>
      ...
      <div class="listBox">
        ...
        <?php //文章列表
            ...
            query_posts("paged=$paged&posts_per_page=20&&category_name=$category_name&orderby=modified&order=DESC"); 
