    ...
    public function getConn() {
        if (!isset($this->_m)) {
            ...
            if (!extension_loaded('memcached')) {
                throw new UserException(UserException::ERROR_EXTENSION_NOT_LOADED, 'EXTENSION_NOT_LOADED', 'memcached');
            }
            // 创建Memcached的实例
    ...
    public function checkResultCode() {
        ...
        switch ($resultCode) {
            ...
            case Memcached::RES_PAYLOAD_FAILURE:
                throw new UserException(UserException::ERROR_MEMCACHED, 'MEMCACHED_ERROR', $resultCode);
                break;
            default :
                return true;
        }
