...
<div class="gMain">
  <form class="gFrm ajaxSubmit" action="../gateway.php?service=ItemDataService&action=doAdd" method="post">
    <table class="gTable" width="100%" border="0" cellpadding="0" cellspacing="1">
      <tr>
        <td class="td1">Item ID：</td>
        <td class="td2"><input type="text" name="item_id" class="positiveIntegerFilter" /></td>
        <td class="td3">说明：道具ID，必须唯一。</td>
      </tr>
      <tr>
        <td class="td1">道具名称：</td>
        <td class="td2"><input type="text" name="item_name" /></td>
        <td class="td3">说明：道具名称。</td>
      </tr>
      <tr>
        <td class="td1">附加信息：</td>
        <td class="td2"><textarea name="extra_info" cols="40" rows="6" readonly="readonly" class="jsonMaker hack"></textarea></td>
        <td class="td3">说明：json编码格式，如：{"event":"UseItem","params":[{"id":1,"num":1},{"id":2,"num":1}]}。</td>
      </tr>
      <tr>
        <td class="td1">道具描述：</td>
        <td class="td2"><textarea name="description" cols="40" rows="6"></textarea></td>
