...
if ($argc < 2) {
    echo <<<EOT
\033[35mUsage: ./top_user_exp_crontab.php <platform>
\033[0m
EOT;
    exit;
}
...
// 追加SNS信息
$tempArr = appendSNSInfo('exp', $dataArr, false);

$dataStr = json_encode($tempArr);
$topDataModel = new TopDataModel('USER_EXP');
